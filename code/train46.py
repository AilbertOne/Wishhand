...
def main():
    ...
    if os.path.exists("./weight_s") is False:
        os.makedirs("./weight_s")
    ...
    image_path = os.path.join(data_root, "wishhand_data", "paper")  # flower data set path
    ...
    for epoch in range(epochs):
        ...
        if val_accurate > best_acc or val_accurate :
